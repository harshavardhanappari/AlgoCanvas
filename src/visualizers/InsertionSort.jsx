...
const InsertionSort = () => {
  ...
  const startSorting = async () => {
    ...
    setStatus("Sorting...");
    setStepTitle("Insertion Sort Started");
    setReason("Insertion Sort inserts each element into its correct position.");
    setAction("Building the sorted portion...");
    ...
    for (let i = 1; i < tempArray.length; i++) {
      ...
      setStepTitle(`Pass ${i}`);
      setReason(`Take ${key} as the key element.`);
      setAction("Finding its correct position.");
      ...
      setReason(
        `${key} has been inserted. The first ${i + 1} elements are now sorted.`,
      );
      setAction("Insertion completed.");
    ...
    setStepTitle("Insertion Sort Completed");
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      ...
      <AlgorithmInfo info={algorithmInfo.insertionSort} />

      {/* Pseudo Code */}

      <PseudoCode
        code={algorithmInfo.insertionSort.pseudoCode}
