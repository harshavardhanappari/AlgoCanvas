...
const algorithmCategories = [
...

  {
    ...
    title: "Arrays",
    description:
      "Learn traversal, prefix sums and sliding window.",
    algorithms: 12,
    icon: FaList,
  },

  {
    ...
    title: "Linked Lists",
    description:
      "Master singly, doubly and circular linked lists.",
    algorithms: 8,
    icon: FaLink,
  },

  {
    ...
    title: "Stacks & Queues",
    description:
      "Understand LIFO, FIFO and monotonic stack concepts.",
    algorithms: 9,
    icon: FaLayerGroup,
  },
...

  {
    ...
    title: "Graphs",
    description:
      "DFS, BFS, Shortest Paths and MST.",
    algorithms: 15,
...

  {
    ...
    description:
      "Build intuition through memoization and tabulation.",
    algorithms: 18,
    icon: FaPuzzlePiece,
  },
